namespace RJCP.Core.Environment.Version.NetFx.Net45
{
    ...
    internal static class NetFxConfig
    {
        ...
        private readonly static Dictionary<int, NetFxVersion> Versions = new Dictionary<int, NetFxVersion>() {
            ...
            { 379893, new NetFxVersion(new Version(4, 5, 2), Messages.Net452) },
            { 393295, new NetFxVersion(new Version(4, 6), Messages.Net46_Win10) },
            { 393297, new NetFxVersion(new Version(4, 6), Messages.Net46) },
            { 394254, new NetFxVersion(new Version(4, 6, 1), Messages.Net461_Win10) },
            { 394271, new NetFxVersion(new Version(4, 6, 1), Messages.Net461) },
            { 394802, new NetFxVersion(new Version(4, 6, 2), Messages.Net462_Win10) },
            { 394806, new NetFxVersion(new Version(4, 6, 2), Messages.Net462) },
            { 460798, new NetFxVersion(new Version(4, 7), Messages.Net47_Win10) },
            { 460805, new NetFxVersion(new Version(4, 7), Messages.Net47) },
            { 461308, new NetFxVersion(new Version(4, 7, 1), Messages.Net471_Win10) },
            { 461310, new NetFxVersion(new Version(4, 7, 1), Messages.Net471) },
            { 461808, new NetFxVersion(new Version(4, 7, 2), Messages.Net472_Win10) },
            { 461814, new NetFxVersion(new Version(4, 7, 2), Messages.Net472) },
            { 528040, new NetFxVersion(new Version(4, 8), Messages.Net48_Win10_1903) },
            { 528049, new NetFxVersion(new Version(4, 8), Messages.Net48) },
            { 528209, new NetFxVersion(new Version(4, 8), Messages.Net48_Win10_1909) },
