namespace System.Throw
{
    ...
    public class ThrowIfEqualTest<T>
    {
        private static void ThrowIfEqual(object value, object other)
        {
            if (value is not null && other is not null) {
                if (typeof(T) == typeof(int)) {
                    ...
                    ThrowHelper.ThrowIfEqual(arg, argOther);
                    return;
